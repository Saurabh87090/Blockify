      ...
      <main className="">
        <div className="relative bg-[#080D28] h-[940px] md:h-[960px] sm:h-[1280px]">
          <div className="lg:float-right  flex justify-center lg:block">
            <img className="w-[360px] ml-[0px] my-0 2xl:w-auto mt-0 lg:w-[480px]" src="Dekstop.svg" alt="" />
          </div>
          ...
          >
            <input
              ...
              className="w-full lg:w-[340px] md:w-[320px] p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-2xl focus:outline-none focus:border-blue-600 caret-blue-600"
            />
